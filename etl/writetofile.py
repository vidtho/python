...
@purpose: This program will create directory and write text to file and replace strings in file
    I am creating a class so that i could create a constructor and create global variables [testdir and testfile]
...
class writetofile:
    ...
    def replacetxt(self):
        ...
        rdic = {'hello':'Welcome', 'world':'Vidya'}
        for line in f1:
